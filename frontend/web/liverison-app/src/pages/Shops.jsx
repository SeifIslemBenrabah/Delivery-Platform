          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {clients.map((client) => (
              ...
              >
                ...
                <p className="text-xs">{client.add}</p>
                <p className="text-sm "> {client.phone}</p>
                <button className="mt-3 px-4 py-1 bg-primary text-white flex flex-row items-center gap-1.5  hover:bg-green-700 rounded-lg text-sm">
                  More Infos
