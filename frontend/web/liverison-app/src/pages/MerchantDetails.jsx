...
const currentShops = shops.slice(indexOfFirstShop, indexOfLastShop);
  ...
  <div key={shop.id} className='w-full bg-white flex flex-row justify-between items-center p-3 text-[12px] rounded-lg shadow-sm'>
    <div>
      <img src={shop.image} alt='shopimg' className='h-11 w-11 rounded-lg' />
    </div>
